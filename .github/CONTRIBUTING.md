...
While the GitHub issue tracker is for *bug reports* and *feature requests*.
You are free to ask questions about `bqt` on the issue tracker. However,
make sure you read any appropriate documentation before asking.
